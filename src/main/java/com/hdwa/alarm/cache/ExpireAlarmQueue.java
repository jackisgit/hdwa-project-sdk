...
public class ExpireAlarmQueue {
    //队列大小
    public static final int QUEUE_MAX_SIZE = 20000;

    public static BlockingQueue<ExpireAlarmMessageVO> blockingQueue = new LinkedBlockingQueue<ExpireAlarmMessageVO>(QUEUE_MAX_SIZE);

    /**
     * 私有的默认构造子，保证外界无法直接实例化
     */
    public ExpireAlarmQueue() {
    }
