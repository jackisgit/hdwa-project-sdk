...
public class DataContainer {
     ...
     * <p>projectId-----数据</p>
     */
    public static ConcurrentHashMap<String, RepositoryImpl> projectMap = new ConcurrentHashMap<>(16);
     ...
     * <p>对象id --->报警列表</p>
     */
    public static ConcurrentHashMap<String, DataValue> id2alarmList = new ConcurrentHashMap<>(16);
     ...
     * <p>对象id --->报警数量</p>
     */
    public static ConcurrentHashMap<String, DataValue> id2alarmCount = new ConcurrentHashMap<>(16);
